...
export interface OrderProduct { // variáveis do produto que aparecerão nas informações do pedido
  code: string;
  price: number;
}
...
export class OrderRepository {
  ...
  async getOrderByEmail(email: string): Promise<Order[]> {
    //operacao QUERY fazemos quando passamos alguma informacao da chave primária composta OU quando fazemos pesquisas com campos indexados
